...
compile:
	...
	clang++ -fsanitize=undefined -fno-omit-frame-pointer -fsanitize=address -Wpedantic -g -ggdb -O1 -fno-optimize-sibling-calls -stdlib=libc++ -std=c++20 -Wall -Wextra -fimplicit-modules -fimplicit-module-maps -fprebuilt-module-path=. main.cpp -c -o main.o
	#clang++ -g -ggdb -Og -std=c++20 -Wall -Wextra -fimplicit-modules -fimplicit-module-maps -fprebuilt-module-path=. lib.pcm -c -o lib.o
	clang++ -fsanitize=undefined -fno-omit-frame-pointer -fsanitize=address -g -ggdb -O1 -fno-optimize-sibling-calls -stdlib=libc++ -std=c++20 -Wall -Wextra -fimplicit-modules -fimplicit-module-maps -fprebuilt-module-path=. main.o -lavformat -lavcodec -lavutil -lavfilter -o main # lib.o
